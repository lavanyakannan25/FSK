...
```
# Output Waveform
![image](https://github.com/user-attachments/assets/d793a9b3-fe26-40e0-b9d4-f7c6cace80e1)

# Results
Thus the FSK(Frequency shift keying) is performed using Python.

# Hardware experiment output waveform.
![WhatsApp Image 2025-05-01 at 20 49 56_359843e5](https://github.com/user-attachments/assets/23dc62b7-97d0-48d6-a86c-47f65ea54eee)
